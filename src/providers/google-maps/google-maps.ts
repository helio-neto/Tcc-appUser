...
export class GoogleMapsProvider {
  ...
  constructor(public http: HttpClient, public connectivity: ConnectivityProvider, public geoLocation: Geolocation, 
              public events: Events, private toastCtrl: ToastController, public pubProv: PubProvider,
    ...
    loadGoogleMaps(): Promise<any> {   
      return new Promise((resolve) => {
        ...
        if(this.connectivity.isOnline()){
          console.log("Conectivity google",this.connectivity.isOnline())
          this.initMap().then(() => {
